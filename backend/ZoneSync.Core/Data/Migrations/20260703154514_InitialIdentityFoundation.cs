        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoftDeleteAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FarmMembership", x => new { x.FarmId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FarmMembership_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvitationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InvitationName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    InvitedEmail = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitation_User_ReceivedByUserId",
                        column: x => x.ReceivedByUserId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invitation_User_SentByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FarmMembership_UserId",
                table: "FarmMembership",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Invitation_InvitationToken",
                table: "Invitation",
                column: "InvitationToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Invitation_ReceivedByUserId",
                table: "Invitation",
                column: "ReceivedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Invitation_SentByUserId",
                table: "Invitation",
                column: "SentByUserId");
